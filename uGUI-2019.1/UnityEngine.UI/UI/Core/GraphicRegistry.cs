...
namespace UnityEngine.UI
{
    ...
    public class GraphicRegistry
    {
        ...
        public static void RegisterGraphicForCanvas(Canvas c, Graphic graphic)//将此元素注册到m_Graphics字典中（每个Canvas对应了一个Graphic序列）
        {
            if (c == null)
                return;
        ...
        public static void UnregisterGraphicForCanvas(Canvas c, Graphic graphic)//清除当前元素
        {
            if (c == null)
                return;
